...
class DialogueGNNModel(nn.Module):
    ...
    def forward(self, U, qmask, umask, seq_lengths, U_a=None, U_v=None, test_label=False,tag=None):
        ...
        if self.graph_type == 'relation':
            ...
            # (1473,300*3)
            emotions_feat = self.graph_model(features_a, features_v, features_l, seq_lengths, qmask, self.use_residue,test_label,tag)
            if test_label:
                index = 15
