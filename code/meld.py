...
def get_MELD_loaders(data_path=None, batch_size=32, valid_rate=0.1, num_workers=0, pin_memory=False):
    path = '../MELD_features_raw1.pkl'
    roberta_path ='../meld_features_roberta_xt.pkl'
...
def get_IEMOCAP_loaders(data_path=None, batch_size=32, valid_rate=0.1, num_workers=0, pin_memory=False):
    path = '/data/tugeng/xt/MM-DFN/data/iemocap/IEMOCAP_features.pkl'
    roberta_path ='/data/tugeng/xt/MM-DFN/data/iemocap/iemocap_features_roberta.pkl'
...
def train_or_eval_graph_model(folder,model, loss_f, dataloader, epoch, flag,is_policy,train_flag=False, optimizer_w=None,optimizer_a=None, cuda_flag=False, modals=None, target_names=None,
    ...
    modal_init = torch.load('../outputs (1)/meldrobmodal/mmdfn_base/model_4.pkl')
    modal_a=torch.load('../outputs (1)/meldrobmodala/mmdfn_base/model_5.pkl')
    modal_v=torch.load('../outputs (1)/meldrobmodalv/mmdfn_base/model_11.pkl')
    modal_l=torch.load('../outputs (1)/meldrobmodall/mmdfn_base/model_15.pkl')
    model_con_a=torch.load('../outputs (1)/meldrobcontexta/mmdfn_base/model_6.pkl')
    model_con_v=torch.load('../outputs (1)/meldrobcontextv/mmdfn_base/model_24.pkl')
    model_con_t=torch.load('../outputs (1)/meldrobcontextl/mmdfn_base/model_23.pkl')
    modal_init.eval()
    modal_a.eval()
    modal_v.eval()
    modal_l.eval()
    ...
    for data in dataloader:
        ...
        # log_prob1, e_i, e_n, e_t, e_l = model_con_v(textf, qmask, umask, lengths, acouf, visuf, True,"visual")
        ...
        log_prob, [ploss_i,ploss_h,ploss_s,ploss_n] = model(textf, qmask, umask, lengths, acouf, visuf, test_label,num_train_layers, flag, train_flag,None,None,None,None,None,None)    
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/data/tugeng/xt/MM-DFN/data/meld/MELD_features_roberta.pkl', help='dataset dir')
    ...
    parser.add_argument('--speaker_weights', type=str, default='0.5-0.5-1.5', help='speaker weight 0-0-0')
    ...
    parser.add_argument('--Deep_GCN_nlayers', type=int, default=32, help='Deep_GCN_nlayers')
    ...
    parser.add_argument('--gamma', type=float, default=1, help='gamma 0.5/1/2')
    ...
    parser.add_argument('--save_model_dir', type=str, default='/data/tugeng/xt/myMM-DFN/outputs/meld_demo2/', help='saved model dir')

    parser.add_argument('--tensorboard', action='store_true', default=False, help='Enables tensorboard log')

    parser.add_argument('--test_label', action='store_true', default=False, help='whether do test only')

    parser.add_argument('--load_model', type=str, default='/home/zouyou/MM-DFNcopy/outputs/meld/mmdfn_base/model_18.pkl', help='trained model dir')
